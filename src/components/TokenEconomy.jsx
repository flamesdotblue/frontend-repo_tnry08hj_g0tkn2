...
const TokenEconomy = () => {
  return (
    <section className="relative mx-auto max-w-7xl px-6 py-20 text-white">
      <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-purple-600/10 via-purple-500/5 to-transparent p-8">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-purple-400/30 bg-purple-500/10 px-3 py-1 text-xs text-purple-200">
              <Coins className="h-4 w-4" /> Tokenized Rewards
            </div>
            ...
            <ul className="mt-6 grid gap-2 text-sm text-white/75 sm:grid-cols-2">
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-purple-400" /> Redeemable discounts on courses</li>
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-purple-400" /> Transferable within your workspace</li>
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-purple-400" /> Automated issuance for achievements</li>
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-purple-400" /> On-chain transparency and caps</li>
            </ul>
          </div>
          ...
          <div className="w-full max-w-md rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur">
            ...
            >
              ...
              <button type="button" onClick={() => {}}
                className="mt-2 inline-flex items-center justify-center gap-2 rounded-xl bg-purple-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-600/30 transition hover:brightness-110">
                Calculate
              </button>
